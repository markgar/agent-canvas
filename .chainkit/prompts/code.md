...
Implement only the owned files. The checkIds refer to immutable acceptance argv
commands in the approved feature document; read them there to execute checks.
Write meaningful tests for the stated behavior, including negative cases. Formatting
